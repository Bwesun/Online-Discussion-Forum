...
$sql="INSERT INTO suggest(name, email, suggest, regnum, datetime)VALUES('$name', '$email', '$suggest', '$regnum', '$datetime')";
//echo $sql;
...
echo "<br />";
echo "<a href='../staff/main_forum.php'>Go back to forum</a>";
}
