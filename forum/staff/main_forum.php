...
$tbl_name = "staff_question"; // Table name 
...
<table id="mentab">
	...
	<!--Home page contents -->
			...
			<td id="onl"><a href="../../" title="Log Out of the Forum">Log Out</a></td>
	</tr>
</table>
<hr></hr>
...
<td ><a href="../staff/view_topic.php?id=<?php echo $rows['id']; ?>"><?php echo $rows['topic']; ?></a><BR></td>
...
<tr>
<td colspan="5" align="right" bgcolor="#E6E6E6"><a href="../staff/create_topic.php"><strong>Create New Topic</strong> </a></td>
</tr>
</table>
</div>
</body>
