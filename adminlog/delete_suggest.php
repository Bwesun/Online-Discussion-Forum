...
<tr>
<td colspan="6" bgcolor="#FFFFFF"><strong>DELETE A SUGGESTION FROM THE UNDERLISTED SUGGESTIONS</strong> 
<tr>
...
<td><a id="and" href="delete_suggest_ac.php?id=<?php echo $rows['id']; ?>">delete</a></td>
</tr>
<tr>
<?php
// close while loop 
